...
[![GitHub Stars](https://img.shields.io/github/stars/chris-cpz/strategy-hshs?style=for-the-badge&logo=github)](https://github.com/chris-cpz/strategy-hshs)
...
```bash
# Clone repository
git clone https://github.com/chris-cpz/strategy-hshs.git
cd strategy-hshs
...
```python
from strategy import hshsStrategy

# Initialize strategy
strategy = hshsStrategy()
...
- **Documentation**: [Wiki](https://github.com/chris-cpz/strategy-hshs/wiki)
- **Issues**: [GitHub Issues](https://github.com/chris-cpz/strategy-hshs/issues)
- **Discussions**: [GitHub Discussions](https://github.com/chris-cpz/strategy-hshs/discussions)
